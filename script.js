...
function showdiv() {
    resume.innerHTML = `<h1 align="center">${inputfields[(id = "name")].value}</h1><br>
...
// REACT JS - This is JS framework that is used to create frontend interphase. It is done with the combination of HTML, CSS and JS.
// 